...
gradient.addColorStop(0,   'rgb(110, 135, 135)');
gradient.addColorStop(0.2, 'rgb(219, 202, 202)');
gradient.addColorStop(0.9, 'rgb(213, 184, 184)');
gradient.addColorStop(1,   'rgb(196, 205, 170)');
...
function createOvalGradient() {
    ...
    ovalGradient.addColorStop(0,   'rgba(255, 255, 255, 0.88)');
    ovalGradient.addColorStop(0.7, 'rgba(91, 75, 197, 0.62)');
    ovalGradient.addColorStop(1,   'rgba(219, 254, 152, 0.82)');
}
createOvalGradient();
